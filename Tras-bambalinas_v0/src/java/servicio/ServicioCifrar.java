...
public class ServicioCifrar {

    private static final String SECRET_KEY = "trasbambalinas";
    private static final String SALT = "telon";
    ...
    public static String decrypt(String strToDecrypt) {
        try {
            ...
            System.out.println("Error decriptando! " + e.toString());
        }
        return null;
    }
